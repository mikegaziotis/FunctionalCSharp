...
public static partial class ResultExtensions
{
    extension<T, TE>(Task<Result<T, TE>> resultTask)
    {
        ...
        /// </summary>
        public async Task<Result<T, TE2>> MapError<TE2>(Func<TE, Task<TE2>> errorFactory)
        {
        ...
        public async Task<Result<T, TE2>> MapError<TE2, TContext>(Func<TE, TContext, Task<TE2>> errorFactory, TContext context)
        {
            var result = await resultTask.ConfigureAwait(DefaultConfigureAwait);
        ...
        ///     If the calling Result is a success, a new success result is returned. Otherwise, creates a new failure result from the return value of a given function.
        /// </summary>
        public async Task<Result<T, TE2>> MapError<TE2>(Func<TE, TE2> errorFactory)
        {
            var result = await resultTask.ConfigureAwait(DefaultConfigureAwait);
            if (result.IsSuccess)
        ...
        public async Task<Result<T, TE2>> MapError<TE2, TContext>(Func<TE, TContext, TE2> errorFactory, TContext context)
        {
            var result = await resultTask.ConfigureAwait(DefaultConfigureAwait);
            if (result.IsSuccess)
                return Result.Success<T, TE2>(result.Value);
