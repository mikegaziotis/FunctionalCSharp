...
public class BindTests_Task_Right : TestBase
{
    [Fact]
    public async Task Bind_Task_Right_returns_no_value_if_initial_Option_is_null()
    {
        Option<T> Option = null;

        var Option2 = await Option.Bind(ExpectAndReturnOption_Task<T>(null, T.Value2));
    ...
    public async Task Bind_Task_Right_returns_no_value_if_selector_returns_null()
    {
        ...
        var Option2 = await Option.Bind(ExpectAndReturn_Task(T.Value, Option<T>.None));
    ...
    public async Task Bind_Task_Right_returns_value_if_selector_returns_value()
    {
        ...
        var Option2 = await Option.Bind(ExpectAndReturnOption_Task<T>(T.Value, T.Value2));
    ...
    [Fact]
    public async Task Bind_Task_Right_with_context_returns_no_value_if_initial_Option_is_null()
    {
        Option<T> Option = null;
